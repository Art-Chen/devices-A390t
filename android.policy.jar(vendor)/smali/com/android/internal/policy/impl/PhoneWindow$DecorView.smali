...
.method public onWindowFocusChanged(Z)V
    ...
    #getter for: Lcom/android/internal/policy/impl/PhoneWindow;->mPanelChordingKey:I
    invoke-static {v5}, Lcom/android/internal/policy/impl/PhoneWindow;->access$400(Lcom/android/internal/policy/impl/PhoneWindow;)I
    ...
    invoke-static {v5}, Lcom/android/internal/policy/impl/PhoneWindow;->access$1400(Lcom/android/internal/policy/impl/PhoneWindow;)Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    move-result-object v5

    iget-object v3, v5, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->mLayoutParams:Landroid/view/ViewGroup$LayoutParams;
    ...
    iget-boolean v5, v3, Landroid/view/WindowManager$LayoutParams;->idleScreenAvailable:Z

    if-eqz v5, :cond_4

    .line 2380
    invoke-interface {v4}, Landroid/view/IWindowManager;->isEventIdleScreenNeeded()Z
    ...
    sget-object v6, Lcom/android/internal/telephony/cat/AppInterface$EventListType;->Event_IdleScreenAvailable:Lcom/android/internal/telephony/cat/AppInterface$EventListType;

    invoke-virtual {v6}, Lcom/android/internal/telephony/cat/AppInterface$EventListType;->value()I
    ...
    invoke-interface {v4, v5}, Landroid/view/IWindowManager;->setInIdleScreen(Z)V
    :try_end_0
    ...
    .restart local v3       #layoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    const-string v6, "Unable to cast layoutParams"
