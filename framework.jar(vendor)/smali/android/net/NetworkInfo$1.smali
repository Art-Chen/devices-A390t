...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/net/NetworkInfo;
    ...
    invoke-static {v6}, Landroid/net/NetworkInfo$State;->valueOf(Ljava/lang/String;)Landroid/net/NetworkInfo$State;

    move-result-object v6

    #setter for: Landroid/net/NetworkInfo;->mState:Landroid/net/NetworkInfo$State;
    invoke-static {v0, v6}, Landroid/net/NetworkInfo;->access$002(Landroid/net/NetworkInfo;Landroid/net/NetworkInfo$State;)Landroid/net/NetworkInfo$State;
    ...
    invoke-static {v6}, Landroid/net/NetworkInfo$DetailedState;->valueOf(Ljava/lang/String;)Landroid/net/NetworkInfo$DetailedState;

    move-result-object v6

    #setter for: Landroid/net/NetworkInfo;->mDetailedState:Landroid/net/NetworkInfo$DetailedState;
    invoke-static {v0, v6}, Landroid/net/NetworkInfo;->access$102(Landroid/net/NetworkInfo;Landroid/net/NetworkInfo$DetailedState;)Landroid/net/NetworkInfo$DetailedState;
    ...
    invoke-static {v0, v6}, Landroid/net/NetworkInfo;->access$202(Landroid/net/NetworkInfo;Z)Z
    ...
    invoke-static {v0, v6}, Landroid/net/NetworkInfo;->access$302(Landroid/net/NetworkInfo;Z)Z
    ...
    invoke-static {v0, v7}, Landroid/net/NetworkInfo;->access$402(Landroid/net/NetworkInfo;Z)Z
    ...
    invoke-static {v0, v6}, Landroid/net/NetworkInfo;->access$502(Landroid/net/NetworkInfo;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v6}, Landroid/net/NetworkInfo;->access$602(Landroid/net/NetworkInfo;Ljava/lang/String;)Ljava/lang/String;
