...
.method public static getOrCreateThreadId(Landroid/content/Context;Ljava/lang/String;)J
    ...
    invoke-static {p0, p1, v0}, Landroid/provider/Telephony$Threads;->getOrCreateThreadId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)J
...
.method public static getOrCreateThreadId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)J
    .locals 4
    .parameter "context"
    .parameter "recipient"
    .parameter "name"
    ...
    .line 1433
    invoke-static {p0, v1, v0}, Landroid/provider/Telephony$Threads;->getOrCreateThreadId(Landroid/content/Context;Ljava/util/Set;Ljava/util/Set;)J
...
.method public static getOrCreateThreadId(Landroid/content/Context;Ljava/util/Set;)J
    ...
    invoke-static {p0, p1, v0}, Landroid/provider/Telephony$Threads;->getOrCreateThreadId(Landroid/content/Context;Ljava/util/Set;Ljava/util/Set;)J
...
.method public static getOrCreateThreadId(Landroid/content/Context;Ljava/util/Set;Ljava/util/Set;)J
    .locals 12
    .parameter "context"
    .parameter
    .parameter
    ...
    .prologue
    .local p1, recipients:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    .local p2, recipientNames:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    const/4 v4, 0x0
    ...
    const-string/jumbo v0, "recipientNames"
