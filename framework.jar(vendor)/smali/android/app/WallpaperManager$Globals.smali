...
.field private static final MSG_CLEAR_WALLPAPER_BY_LOCKSCREEN:I = 0x2

.field private static final MSG_CLEAR_WALLPAPER_BY_MAINMENU:I = 0x3
...
.field private mMainMenuScreenWallpaper:Landroid/graphics/Bitmap;
...
.method static synthetic access$302(Landroid/app/WallpaperManager$Globals;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 180
    iput-object p1, p0, Landroid/app/WallpaperManager$Globals;->mMainMenuScreenWallpaper:Landroid/graphics/Bitmap;
...
.method private getCurrentWallpaperLocked(I)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v7, p0, v5, p1}, Landroid/app/IWallpaperManager;->getWallpaperByTarget(Landroid/app/IWallpaperManagerCallback;Landroid/os/Bundle;I)Landroid/os/ParcelFileDescriptor;
...
.method public forgetLoadedWallpaper()V
    ...
    iput-object v0, p0, Landroid/app/WallpaperManager$Globals;->mLockScreenWallpaper:Landroid/graphics/Bitmap;

    .line 284
    const/4 v0, 0x0

    iput-object v0, p0, Landroid/app/WallpaperManager$Globals;->mMainMenuScreenWallpaper:Landroid/graphics/Bitmap;
...
.method public peekWallpaperBitmap(Landroid/content/Context;ZI)Landroid/graphics/Bitmap;
    ...
    .line 379
    :try_start_0
    iget-object v1, p0, Landroid/app/WallpaperManager$Globals;->mLockScreenWallpaper:Landroid/graphics/Bitmap;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p3}, Landroid/app/WallpaperManager$Globals;->getCurrentWallpaperLocked(I)Landroid/graphics/Bitmap;

    move-result-object v1

    iput-object v1, p0, Landroid/app/WallpaperManager$Globals;->mLockScreenWallpaper:Landroid/graphics/Bitmap;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Ljava/lang/OutOfMemoryError; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 400
    :try_start_3
    iget-object v1, p0, Landroid/app/WallpaperManager$Globals;->mMainMenuScreenWallpaper:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, Landroid/app/WallpaperManager$Globals;->mMainMenuScreenWallpaper:Landroid/graphics/Bitmap;
    :try_end_4
