...
.field static sThemeManager:Landroid/theme/IThemeManager;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/ActivityThread;->UNIVERSE_UI_SUPPORT:Z
...
.method private attachThemeAssets(Landroid/content/res/AssetManager;Landroid/theme/ThemeInfo;Z)Z
    .locals 4
    .parameter "assets"
    .parameter "theme"
    .parameter "forSystem"
    ...
    .line 4511
    :cond_1
    invoke-virtual {p1, p3}, Landroid/content/res/AssetManager;->getThemeCookie(Z)I
    ...
    .line 4515
    invoke-virtual {p2}, Landroid/theme/ThemeInfo;->getTargetResDir()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p2}, Landroid/theme/ThemeInfo;->getResDir()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p1, v2, v3}, Landroid/content/res/AssetManager;->attachThemePath(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 4517
    invoke-virtual {p2}, Landroid/theme/ThemeInfo;->getPackageName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1, v1, p3}, Landroid/content/res/AssetManager;->setThemePackageName(Ljava/lang/String;Z)V

    .line 4518
    invoke-virtual {p1, v0, p3}, Landroid/content/res/AssetManager;->setThemeCookie(IZ)V
...
.method public static getThemeManager()Landroid/theme/IThemeManager;
    .locals 2

    .prologue
    .line 1407
    sget-object v1, Landroid/app/ActivityThread;->sThemeManager:Landroid/theme/IThemeManager;
    ...
    sput-object v1, Landroid/app/ActivityThread;->sThemeManager:Landroid/theme/IThemeManager;
...
.method getTopLevelResources(Ljava/lang/String;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;)Landroid/content/res/Resources;
...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;)Landroid/content/res/Resources;
...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;)Landroid/content/res/Resources;
    ...
    .prologue
    .line 1479
    new-instance v4, Landroid/app/ActivityThread$ResourcesKey;

    iget v9, p2, Landroid/content/res/CompatibilityInfo;->applicationScale:F

    invoke-direct {v4, p1, v9}, Landroid/app/ActivityThread$ResourcesKey;-><init>(Ljava/lang/String;F)V

    .line 1481
    .local v4, key:Landroid/app/ActivityThread$ResourcesKey;
    ...
    .line 1510
    .local v3, isCTSTest:Z
    if-eqz p3, :cond_3

    const-string v9, "com.android.cts.holo"
    ...
    .line 1513
    :cond_3
    sget-boolean v9, Landroid/app/ActivityThread;->UNIVERSE_UI_SUPPORT:Z
    ...
    .line 1515
    .local v7, sysTheme:Landroid/theme/ThemeInfo;
    const/4 v0, 0x0

    .line 1517
    .local v0, appTheme:Landroid/theme/ThemeInfo;
    :try_start_2
    invoke-static {}, Landroid/app/ActivityThread;->getThemeManager()Landroid/theme/IThemeManager;

    move-result-object v9

    const-string v10, "/system/framework/framework-res.apk"

    invoke-interface {v9, v10}, Landroid/theme/IThemeManager;->getAppliedTheme(Ljava/lang/String;)Landroid/theme/ThemeInfo;
    ...
    invoke-interface {v9, p1}, Landroid/theme/IThemeManager;->getAppliedTheme(Ljava/lang/String;)Landroid/theme/ThemeInfo;
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-direct {p0, v1, v7, v9}, Landroid/app/ActivityThread;->attachThemeAssets(Landroid/content/res/AssetManager;Landroid/theme/ThemeInfo;Z)Z

    .line 1522
    const/4 v9, 0x0

    invoke-direct {p0, v1, v0, v9}, Landroid/app/ActivityThread;->attachThemeAssets(Landroid/content/res/AssetManager;Landroid/theme/ThemeInfo;Z)Z
    ...
    invoke-direct {p0, v9, v7, v10}, Landroid/app/ActivityThread;->attachThemeAssets(Landroid/content/res/AssetManager;Landroid/theme/ThemeInfo;Z)Z

    .line 1528
    .end local v0           #appTheme:Landroid/theme/ThemeInfo;
    .end local v7           #sysTheme:Landroid/theme/ThemeInfo;
    :cond_4
    const/4 v9, 0x0
    ...
    invoke-direct {v6, v1, v5, v9, p2}, Landroid/content/res/Resources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .restart local v0       #appTheme:Landroid/theme/ThemeInfo;
    .restart local v7       #sysTheme:Landroid/theme/ThemeInfo;
    :catch_0
    move-exception v9
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZ)V
    ...
    .line 2553
    iput-boolean v8, v3, Landroid/view/WindowManager$LayoutParams;->idleScreenAvailable:Z
    ...
    .restart local v6       #wm:Landroid/view/ViewManager;
    :cond_8
    iput-boolean v7, v3, Landroid/view/WindowManager$LayoutParams;->idleScreenAvailable:Z
