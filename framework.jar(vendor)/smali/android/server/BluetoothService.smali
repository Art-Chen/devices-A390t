...
.field private static final DISCOVERABLE_ALARM:Ljava/lang/String; = "android.server.bluetoothservice.action.DISCOVERABLEALARM"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v2, "android.server.bluetoothservice.action.DISCOVERABLEALARM"
...
.method private closeProfileProxy()V
    ...
    invoke-virtual {v0}, Landroid/server/BluetoothBondState;->closeProfileProxyService()V
...
.method getAddressFromObjectPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Landroid/server/BluetoothAdapterProperties;->getObjectPath()Ljava/lang/String;
    ...
    .line 2035
    invoke-virtual {p0}, Landroid/server/BluetoothService;->getAdapterPathNative()Ljava/lang/String;
    ...
    const-string v6, "getAddressFromObjectPath: adapterPath = "
    ...
    invoke-virtual {v4, v5, v6}, Landroid/server/BluetoothAdapterProperties;->setProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "  or deviceObjectPath:"
    ...
    const-string v6, "  is not a prefix of deviceObjectPath:"
    ...
    const-string v6, "bluetoothd crashed ?"
    ...
    const-string v5, "getAddressFromObjectPath: Address being returned is null"
...
.method public declared-synchronized isInBondingSate()Z
    .locals 3
    ...
    invoke-virtual {v1, v2}, Landroid/server/BluetoothBondState;->listInState(I)[Ljava/lang/String;

    move-result-object v0

    .line 1146
    .local v0, bondingDevices:[Ljava/lang/String;
    array-length v1, v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1145
    .end local v0           #bondingDevices:[Ljava/lang/String;
    :catchall_0
    move-exception v1
