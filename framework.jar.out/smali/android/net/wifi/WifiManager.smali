...
.field public static final ACTION_WIFI_TO_GPRS:Ljava/lang/String; = "sprd.com.android.wifi.to.gprs"
...
.field public static final EXTRA_SUPPLICANT_KEY_INCORRECT:Ljava/lang/String; = "supplicantKeyIncorrect"
...
.field public static final WAPI_EVENT_CERT_LOST_CODE:I = 0x12
...
.field public static final WPA_SUPPLICANT_KEY_INCORRECT:I = 0xf
...
.method public disconnectAp()V
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->disconnectAp()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public reconnectAP()Z
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->reconnectAP()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setAutoConnect(Z)Z
    .locals 2
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setAutoConnect(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setGprsConnectState(Z)Z
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setGprsConnectState(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setGprsToWifi(Z)Z
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setGprsToWifi(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setTrustListPriority(Ljava/lang/String;I)Z
    ...
    invoke-interface {v1, p1, p2}, Landroid/net/wifi/IWifiManager;->setTrustListPriority(Ljava/lang/String;I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
