...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/os/RecoverySystem;->CACHE_DIR:Ljava/lang/String;
...
.method private static bootCommand(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v10}, Landroid/os/RecoverySystem;->runCommandLine(Ljava/lang/String;)V

    .line 382
    new-instance v6, Landroid/os/StatFs;

    sget-object v10, Landroid/os/RecoverySystem;->CACHE_DIR:Ljava/lang/String;

    invoke-direct {v6, v10}, Landroid/os/StatFs;-><init>(Ljava/lang/String;)V

    .line 383
    .local v6, cache_stat:Landroid/os/StatFs;
    ...
    const-string v12, "Cache free size "
    ...
    const-string v11, "May be need more space, Clean Cache Directory"
    ...
    invoke-static {v10}, Landroid/os/RecoverySystem;->cleanCache(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {v6, v10}, Landroid/os/StatFs;->restat(Ljava/lang/String;)V
    ...
    .line 400
    invoke-virtual {v6}, Landroid/os/StatFs;->finalize()V
    ...
    const-string v12, "Now Cache free size "
    ...
    invoke-direct {v7, v10}, Ljava/io/FileWriter;-><init>(Ljava/io/File;)V
    ...
    const-string v12, "Counter a exception during clean cache"
...
.method private static cleanCache(Ljava/lang/String;)V
    .locals 8
    .parameter "filepath"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v5}, Landroid/os/RecoverySystem;->cleanCache(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v7, "cant delete directory for security"
...
.method private static runCommandLine(Ljava/lang/String;)V
    .locals 9
    .parameter "command"
    ...
    const-string/jumbo v8, "runCommandLine "
...
.method public static verifyPackage(Ljava/io/File;Landroid/os/RecoverySystem$ProgressListener;Ljava/io/File;)V
    ...
    const-string v44, "comment size %d; signature start %d"
