...
.field private static final MEDIA_SCANNER_OPT_DEBUG:Z = false
...
.field private mDefaultMmsSoundFilename:Ljava/lang/String;

.field private mDefaultMmsSoundSet:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/media/MediaScanner;->PHONE_COUNT:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/media/MediaScanner;->mDefaultRingtoneSet:[Z
...
.method private getNearestParent(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    .locals 7
    .parameter "path"
    .parameter "parents"
    ...
    .line 1136
    .local v1, foundParent:Ljava/lang/String;
    move-object v0, p2
...
.method private isExcluded(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
    .locals 4
    .parameter "path"
    .parameter "directories"
    ...
    .prologue
    .line 1123
    invoke-direct {p0, p1, p2}, Landroid/media/MediaScanner;->getNearestParent(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    .line 1124
    .local v1, includedParent:Ljava/lang/String;
    invoke-direct {p0, p1, p3}, Landroid/media/MediaScanner;->getNearestParent(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 1126
    .local v0, excludedParent:Ljava/lang/String;
...
.method private postscan([Ljava/lang/String;[Ljava/lang/String;)V
    .locals 23
    .parameter "directories"
    ...
    .line 1204
    .local v6, entriesToRemove:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/media/MediaScanner$FileCacheEntry;>;"
    move-object/from16 v0, p0

    iget-object v5, v0, Landroid/media/MediaScanner;->mMediaDeleter:Landroid/media/MediaDeleter;

    .line 1205
    .local v5, deleter:Landroid/media/MediaDeleter;
    move-object/from16 v0, p0
    ...
    .line 1207
    .local v17, updater:Landroid/media/MediaUpdater;
    :cond_0
    :goto_0
    ...
    iget-object v0, v7, Landroid/media/MediaScanner$FileCacheEntry;->mPath:Ljava/lang/String;
    ...
    const-string/jumbo v20, "storage"
    ...
    iget-boolean v0, v7, Landroid/media/MediaScanner$FileCacheEntry;->mSeenInFileSystem:Z

    move/from16 v19, v0

    if-nez v19, :cond_1

    iget v0, v7, Landroid/media/MediaScanner$FileCacheEntry;->mFormat:I

    move/from16 v19, v0

    invoke-static/range {v19 .. v19}, Landroid/mtp/MtpConstants;->isAbstractObject(I)Z
    ...
    invoke-direct {v0, v14, v1, v2}, Landroid/media/MediaScanner;->isExcluded(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    :cond_2
    iget v9, v12, Landroid/media/MediaFile$MediaFileType;->fileType:I
    ...
    invoke-direct {v0, v14, v1}, Landroid/media/MediaScanner;->getNearestParent(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    .line 1225
    .local v13, nearestParent:Ljava/lang/String;
    ...
    invoke-virtual {v15, v13}, Landroid/os/storage/StorageManager;->getVolumeState(Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v13           #nearestParent:Ljava/lang/String;
    ...
    const-string/jumbo v21, "updater.update entries count "
    ...
    iget-wide v0, v7, Landroid/media/MediaScanner$FileCacheEntry;->mRowId:J
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/media/MediaUpdater;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .line 1266
    invoke-virtual/range {v17 .. v17}, Landroid/media/MediaUpdater;->flushAll()V
    ...
    const-string v21, "deleter.delete entries count "
    ...
    invoke-interface/range {v19 .. v22}, Landroid/content/IContentProvider;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v5, v0, v1, v2}, Landroid/media/MediaDeleter;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .line 1286
    invoke-virtual {v5}, Landroid/media/MediaDeleter;->flushAll()V
    ...
    invoke-static/range {v20 .. v20}, Landroid/provider/MediaStore$Images$Media;->getContentUri(Ljava/lang/String;)Landroid/net/Uri;
...
.method private setDefaultRingtoneFileNames()V
    ...
    .local v0, i:I
    :goto_0
    sget v1, Landroid/media/MediaScanner;->PHONE_COUNT:I
    ...
    const-string/jumbo v3, "ro.config."
    ...
    invoke-static {v3, v0}, Lcom/android/internal/telephony/PhoneFactory;->getSetting(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 429
    const-string/jumbo v1, "ro.config.mms_sound"

    invoke-static {v1}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Landroid/media/MediaScanner;->mDefaultMmsSoundFilename:Ljava/lang/String;
...
.method public scanDirectories([Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)V
    .locals 22
    .parameter "directories"
    ...
    invoke-direct/range {v18 .. v20}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;I)V
    ...
    instance-of v0, v0, Landroid/content/IContentProviderEx;
    ...
    const-string v19, "MediaProvider implements IContentProviderEx, enable bulk operations"

    invoke-static/range {v18 .. v19}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1342
    new-instance v18, Landroid/media/MediaUpdater;
    ...
    invoke-direct/range {v18 .. v20}, Landroid/media/MediaUpdater;-><init>(Landroid/content/IContentProvider;I)V
    ...
    .line 1343
    new-instance v18, Landroid/media/MediaDeleter;
    ...
    invoke-direct/range {v18 .. v20}, Landroid/media/MediaDeleter;-><init>(Landroid/content/IContentProvider;I)V
    ...
    const-string v20, "====== processDirectory "
    ...
    const-string v19, "MediaProvider does not implement IContentProviderEx, disable bulk operations"
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/media/MediaUpdater;->flushAll()V
    ...
    .end local v11           #path:Ljava/lang/String;
    :cond_6
    invoke-direct/range {p0 .. p2}, Landroid/media/MediaScanner;->postscan([Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/media/MediaDeleter;->flushAll()V
