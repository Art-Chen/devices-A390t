...
.field private static final TAG:Ljava/lang/String; = "PduComposer"
...
.method private appendHeader(I)I
    ...
    const-string v22, "appendHeader field = "
    ...
    const-string v22, "appendHeader <status,reportallowed,priority,delivery,read> octet = "
    ...
    const-string v22, "appendHeader expiry = "
...
.method private makeMessage(IZ)[B
    .locals 2
    .parameter "type"
    .parameter "forBackup"
    ...
    .line 196
    :pswitch_1
    invoke-direct {p0, p1, p2}, Lcom/google/android/mms/pdu/PduComposer;->makeSendReqPdu(IZ)I
...
.method private makeMessageBody()I
    ...
    const-string/jumbo v31, "makeMessageBody contentType = "
    ...
    const-string/jumbo v31, "makeMessageBody part.getContentType() = "
    ...
    invoke-static/range {v31 .. v31}, Lcom/google/android/mms/pdu/PduPersister;->toUTF8String([B)Ljava/lang/String;
    ...
    const-string/jumbo v31, "makeMessageBody partNum --> begin for :  "
    ...
    const-string/jumbo v31, "makeMessageBody partNum partContentType =  "

    invoke-virtual/range {v30 .. v31}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v30

    invoke-static/range {v24 .. v24}, Lcom/google/android/mms/pdu/PduPersister;->toUTF8String([B)Ljava/lang/String;
    ...
    const-string/jumbo v31, "makeMessageBody partNum PduPart.P_DEP_NAME =  "

    invoke-virtual/range {v30 .. v31}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v30

    invoke-static/range {v22 .. v22}, Lcom/google/android/mms/pdu/PduPersister;->toUTF8String([B)Ljava/lang/String;
    ...
    const-string/jumbo v31, "makeMessageBody partNum charset =  "
    ...
    const-string/jumbo v30, "makeMessageBody partNum  charset >> 7 == 0 "
    ...
    const-string/jumbo v31, "makeMessageBody partNum contentLocation = "

    invoke-virtual/range {v30 .. v31}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v30

    invoke-static {v9}, Lcom/google/android/mms/pdu/PduPersister;->toUTF8String([B)Ljava/lang/String;
    ...
    const-string/jumbo v31, "makeMessageBody partNum headerLength =  "
...
.method private makeSendReqPdu()I
    ...
    const-string v5, "----------------------- makeSendReqPdu start ----------------------- "
    ...
    const-string v4, "----------------------- makeSendReqPdu end -------------------------- "
...
.method private makeSendReqPdu(IZ)I
    .locals 8
    .parameter "type"
    .parameter "forBackup"
...
.method public makeForBackupMms()[B
    .locals 2
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/android/mms/pdu/PduComposer;->makeMessage(IZ)[B
