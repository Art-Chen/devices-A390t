...
.field private static final EVENT_CHANGE_FDN_PASSWORD_DONE:I = 0x10
...
.field private static final EVENT_QUERY_PIN1_RETRY_COUNT_DONE:I = 0x11

.field private static final EVENT_QUERY_PIN2_RETRY_COUNT_DONE:I = 0x12
...
.field public static final INTENT_KEY_FDN_SIM_REFRESH:Ljava/lang/String; = "fdn_sim_refresh"

.field public static final INTENT_KEY_FDN_STAUS:Ljava/lang/String; = "fdn_status"
...
.field public static final INTENT_KEY_PHONE_ID:Ljava/lang/String; = "phone_id"
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    .line 553
    iput-boolean v1, p0, Lcom/android/internal/telephony/IccCard;->misFirstStart:Z
...
.method static synthetic access$200(Lcom/android/internal/telephony/IccCard;Landroid/os/AsyncResult;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$900(Lcom/android/internal/telephony/IccCard;)V
    ...
    .prologue
    .line 47
    invoke-direct {p0}, Lcom/android/internal/telephony/IccCard;->broadFdnStatusChangeIntent()V

    return-void
.end method

.method private broadFdnStatusChangeIntent()V
    .locals 3
    ...
    const-string v2, " broadFdnStatusChange sendBroadcast FDN_STATE_CHANGED"
    ...
    const-string v2, "android.intent.action.FDN_STATE_CHANGED"
    ...
    .line 593
    const-string v1, "fdn_status"

    invoke-virtual {p0}, Lcom/android/internal/telephony/IccCard;->getIccFdnEnabled()Z
...
.method private getAppState(I)Lcom/android/internal/telephony/IccCard$State;
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/IccCardApplication$AppState;->isIccBlocked()Z
...
.method private handleIccCardStatus(Lcom/android/internal/telephony/IccCardStatus;)V
    ...
    iget-object v5, v0, Lcom/android/internal/telephony/IccCard;->mState:Lcom/android/internal/telephony/IccCard$State;

    .line 476
    .local v5, oldState:Lcom/android/internal/telephony/IccCard$State;
    ...
    invoke-static {v14, v15}, Lcom/android/internal/telephony/PhoneFactory;->autoSetDefaultPhoneId(ZI)I
    ...
    :goto_2
    sget-object v14, Lcom/android/internal/telephony/IccCard$State;->BLOCKED:Lcom/android/internal/telephony/IccCard$State;
    ...
    .line 491
    .local v9, transitionedIntoIccBlocked:Z
    :goto_3
    ...
    .line 494
    .local v10, transitionedIntoIccReady:Z
    :goto_5
    if-nez v7, :cond_e
    ...
    .line 496
    .local v8, transitionedIntoCardPresent:Z
    :goto_6
    if-eqz v5, :cond_f
    ...
    invoke-virtual {v0, v15, v14}, Lcom/android/internal/telephony/IccCard;->broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v15, " misFirstStart"
    ...
    iget-boolean v15, v0, Lcom/android/internal/telephony/IccCard;->misFirstStart:Z
    ...
    .line 534
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/IccCard;->hasIccCard()Z
    ...
    iget-boolean v14, v0, Lcom/android/internal/telephony/IccCard;->misFirstStart:Z
    ...
    iput-boolean v14, v0, Lcom/android/internal/telephony/IccCard;->misFirstStart:Z

    .line 536
    new-instance v6, Landroid/content/Intent;

    const-string v14, "android.intent.action.SIM_READY_LOAD_ICCID"
    ...
    invoke-static {v14, v15}, Lcom/android/internal/telephony/PhoneFactory;->getAction(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 538
    .local v6, simReadyLoadIccId:Landroid/content/Intent;
    ...
    .line 541
    const-string v14, "Broadcasting intent load iccid"
    ...
    invoke-static {v6, v14}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;)V

    .line 546
    .end local v6           #simReadyLoadIccId:Landroid/content/Intent;
    :cond_6
    if-eqz v3, :cond_1d
    ...
    .end local v8           #transitionedIntoCardPresent:Z
    .end local v9           #transitionedIntoIccBlocked:Z
    .end local v10           #transitionedIntoIccReady:Z
    ...
    .line 491
    .restart local v9       #transitionedIntoIccBlocked:Z
    :cond_c
    const/4 v12, 0x0
    ...
    .line 494
    .restart local v10       #transitionedIntoIccReady:Z
    :cond_e
    const/4 v8, 0x0
    ...
    .line 496
    .restart local v8       #transitionedIntoCardPresent:Z
    :cond_f
    const/4 v3, 0x0
    ...
    const-string v14, "Notify SIM network locked."
    ...
    iget-object v14, v0, Lcom/android/internal/telephony/IccCard;->mNetworkLockedRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v14, "Notify SIM permanently disabled."
    ...
    const-string v14, "Notify ICC blocked."
    ...
    .line 524
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/IccCard;->broadcastGetIccStatusDoneIntent()V
    ...
    const-string v14, "Notify SIM ready."
    ...
    const-string v14, "Notify SIM present."
    ...
    .line 528
    :cond_1c
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/IccCard;->broadcastIccCardPresentIntent()V
...
.method private parsePinPukErrorResult(Landroid/os/AsyncResult;Z)V
    ...
    const-string/jumbo v3, "mPin1RetryCount is "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/internal/telephony/IccCard;->mPin1RetryCount:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ",mPin2RetryCount is "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/internal/telephony/IccCard;->mPin2RetryCount:I
...
# virtual methods
.method public broadcastGetIccStatusDoneIntent()V
    .locals 3
    ...
    const-string v1, "android.intent.action.GET_ICC_STATUS_DONE"
    ...
    const-string v2, "Broadcasting intent ACTION_GET_ICC_STATUS_DONE , phoneid is "
...
.method public broadcastIccCardPresentIntent()V
    .locals 3
    ...
    const-string v1, "android.intent.action.SIM_CARD_PRESENT"
    ...
    const-string v2, "Broadcasting intent SIM_CARD_PRESENT , phoneid is "
...
.method public queryFacilityFdnDone()V
    .locals 6
    ...
    const-string v4, "IccCard  queryFacilityFdnDone"
    ...
    invoke-interface {v3, v4, v5, v2, v1}, Lcom/android/internal/telephony/CommandsInterface;->queryFacilityLock(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Message;)V

    .line 581
    iget-object v3, p0, Lcom/android/internal/telephony/IccCard;->mLogTag:Ljava/lang/String;

    const-string v4, " queryFacilityFdnDone sendBroadcast FDN_STATE_CHANGED"
    ...
    const-string v4, "android.intent.action.FDN_STATE_CHANGED"
    ...
    .line 585
    const-string v3, "fdn_sim_refresh"
...
.method public setIccLockEnabled(Z)V
    .locals 0
    .parameter "enabled"
