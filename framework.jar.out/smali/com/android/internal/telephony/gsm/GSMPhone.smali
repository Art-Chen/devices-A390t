.class public abstract Lcom/android/internal/telephony/gsm/GSMPhone;
...
.field private static final MAX_INIT_QUERY_CF_COUNT:I = 0x8

.field private static final MO_CALL:I = 0x0

.field private static final MT_CALL:I = 0x1

.field private static final NOTIFICATION_ID_USSD:I = 0x12c

.field public static final VM_NUMBER:Ljava/lang/String; = "vm_number_key"

.field public static final VM_SIM_IMSI:Ljava/lang/String; = "vm_sim_imsi_key"

.field private static final getCallForwardLock:Ljava/lang/String; = ""
...
.field private initQueryCountCF:I

.field private initQueryCountCF_BUSY:I

.field private initQueryCountCF_NOANSWER:I

.field private initQueryCountCF_NOTREACHABLE:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    .line 134
    iput v7, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF:I

    .line 135
    iput v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_BUSY:I

    .line 136
    iput v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_NOANSWER:I

    .line 137
    iput v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_NOTREACHABLE:I
    ...
    .line 161
    new-instance v0, Lcom/android/internal/telephony/gsm/TDUSIMFileHandler;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/gsm/TDUSIMFileHandler;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    invoke-interface {v0, p0, v7, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForOffOrNotAvailable(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private dealEventCFGetDone(ILandroid/os/Message;I)I
    .locals 5
    .parameter "reason"
    .parameter "msg"
    .parameter "initCount"
    ...
    invoke-direct {p0, v2, p1, p3}, Lcom/android/internal/telephony/gsm/GSMPhone;->handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;II)I
    ...
    const-string v4, " handleCfuQueryResult() exception:"
    ...
    const-string v4, " Call getCallForwardingOption() reason:"
    ...
    invoke-virtual {p0, p1, v2, v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->getCallForwardingOption(IILandroid/os/Message;)V

    goto :goto_0
.end method

.method private dealEventCFSetDone(ILandroid/os/Message;)V
    .locals 5
    .parameter "reason"
    .parameter "msg"
    ...
    const-string/jumbo v4, "setCallForwardSetting(sim:"
    ...
    invoke-static {v2, v3, v4, p1}, Landroid/telephony/TelephonyManager;->setCallForwardSetting(Landroid/content/Context;III)V
    ...
    const-string v4, " setCallForwardSetting() exception:"
...
.method private handleCfuQueryResult([Lcom/android/internal/telephony/CallForwardInfo;II)I
    .locals 8
    .parameter "infos"
    .parameter "reason"
    .parameter "initCount"
    ...
    const-string v7, " handleCfuQueryResult() infos is null"
    ...
    const-string v7, " Call getCallForwardingOption() reason:"
    ...
    invoke-virtual {p0, p2, v4, v5}, Lcom/android/internal/telephony/gsm/GSMPhone;->getCallForwardingOption(IILandroid/os/Message;)V
    ...
    const-string v7, " handleCfuQueryResult() start exec"
    ...
    const-string/jumbo v7, "setCallForwardSetting(sim:"
    ...
    const-string v7, ") and set initCount 0"
    ...
    invoke-static {v5, v6, v0, p2}, Landroid/telephony/TelephonyManager;->setCallForwardSetting(Landroid/content/Context;III)V
    ...
    invoke-virtual {v5, v4, v2}, Lcom/android/internal/telephony/IccRecords;->setVoiceCallForwardingFlag(IZ)V

    goto/16 :goto_0

    .end local v0           #CFInt:I
...
.method private handleSetSelectNetwork(Landroid/os/AsyncResult;)V
    ...
    instance-of v1, v1, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;
    ...
    check-cast v0, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;

    .line 1621
    .local v0, nsm:Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;
    iget-object v1, v0, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;->message:Landroid/os/Message;
    ...
    const-string/jumbo v2, "sending original message to recipient"
...
.method private setVmSimImsi(Ljava/lang/String;)V
    ...
    invoke-static {v2, v3}, Lcom/android/internal/telephony/PhoneFactory;->getSetting(Ljava/lang/String;I)Ljava/lang/String;
...
.method public changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v2, "changeBarringPassword: "
    ...
    invoke-interface {v0, p1, p2, p3, v1}, Lcom/android/internal/telephony/CommandsInterface;->changeBarringPassword(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v12, "EVENT_USSD  ar.exception != null"
    ...
    .line 1296
    .local v3, found:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    const/4 v4, 0x0
    ...
    .end local v3           #found:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    check-cast v3, Lcom/android/internal/telephony/gsm/GsmMmiCode;

    .line 1302
    .restart local v3       #found:Lcom/android/internal/telephony/gsm/GsmMmiCode;
    :cond_1
    if-eqz v3, :cond_0
    ...
    const-string v12, "EVENT_USSD found != null"
    ...
    .line 1336
    .local v9, ssn:Lcom/android/internal/telephony/gsm/SuppServiceNotification;
    iget v11, v9, Lcom/android/internal/telephony/gsm/SuppServiceNotification;->notificationType:I

    if-nez v11, :cond_6

    .line 1337
    iget v11, v9, Lcom/android/internal/telephony/gsm/SuppServiceNotification;->code:I
    ...
    invoke-static {v11, v1, v12}, Landroid/widget/Toast;->makeText(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;
    ...
    .end local v9           #ssn:Lcom/android/internal/telephony/gsm/SuppServiceNotification;
    :sswitch_e
    iget-object v0, p1, Landroid/os/Message;->obj:Ljava/lang/Object;
    ...
    invoke-static {v7, v11, v12}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    .line 1451
    .restart local v0       #ar:Landroid/os/AsyncResult;
    const-class v11, Lcom/android/internal/telephony/IccVmNotSupportedException;
    ...
    invoke-direct {p0, v11, p1}, Lcom/android/internal/telephony/gsm/GSMPhone;->dealEventCFSetDone(ILandroid/os/Message;)V
    ...
    :try_start_1
    iget v13, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF:I

    invoke-direct {p0, v11, p1, v13}, Lcom/android/internal/telephony/gsm/GSMPhone;->dealEventCFGetDone(ILandroid/os/Message;I)I

    move-result v11

    iput v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF:I
    ...
    :try_start_2
    iget v13, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_BUSY:I

    invoke-direct {p0, v11, p1, v13}, Lcom/android/internal/telephony/gsm/GSMPhone;->dealEventCFGetDone(ILandroid/os/Message;I)I

    move-result v11

    iput v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_BUSY:I
    ...
    :try_start_3
    iget v13, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_NOANSWER:I

    invoke-direct {p0, v11, p1, v13}, Lcom/android/internal/telephony/gsm/GSMPhone;->dealEventCFGetDone(ILandroid/os/Message;I)I

    move-result v11

    iput v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_NOANSWER:I
    ...
    :try_start_4
    iget v13, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_NOTREACHABLE:I

    invoke-direct {p0, v11, p1, v13}, Lcom/android/internal/telephony/gsm/GSMPhone;->dealEventCFGetDone(ILandroid/os/Message;I)I

    move-result v11

    iput v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->initQueryCountCF_NOTREACHABLE:I
...
.method notifySuppServiceSucc(Lcom/android/internal/telephony/Phone$SuppService;)V
    .locals 1
    .parameter "code"
...
.method public playSptone(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, v1}, Lcom/android/internal/telephony/CommandsInterface;->setTone(Ljava/lang/String;Landroid/os/Message;)V
...
.method public queryFacilityLock(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Message;)V
    ...
    const-string/jumbo v2, "queryFacilityLock: "
    ...
    invoke-interface {v0, p1, p2, p3, v1}, Lcom/android/internal/telephony/CommandsInterface;->queryFacilityLock(Ljava/lang/String;Ljava/lang/String;ILandroid/os/Message;)V
...
.method public registerForGprsAttached(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v1, " This registerForGprsAttached for GSM."
...
.method public selectNetworkManually(Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    ...
    iput v2, v1, Lcom/android/internal/telephony/gsm/GSMPhone$NetworkSelectMessage;->operatorAct:I
...
.method public setFacilityLock(Ljava/lang/String;ZLjava/lang/String;ILandroid/os/Message;)V
    ...
    const-string/jumbo v2, "setFacilityLock: "
    ...
    invoke-virtual {p0, v1, p5}, Lcom/android/internal/telephony/gsm/GSMPhone;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public unregisterForGprsAttached(Landroid/os/Handler;)V
    ...
    const-string v1, " This unregisterForGprsAttached for GSM."
...
.method updateCurrentCarrierInProvider()Z
    ...
    invoke-static {v3}, Landroid/provider/Telephony$Carriers;->getContentUri(I)Landroid/net/Uri;
