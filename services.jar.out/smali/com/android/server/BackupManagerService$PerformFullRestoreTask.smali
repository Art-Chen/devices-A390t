...
.method decodeAesHeaderAndInitialize(Ljava/lang/String;Ljava/io/InputStream;)Ljava/io/InputStream;
    ...
    invoke-static {v0, v1}, Lcom/android/server/BackupManagerService;->access$invoke-hexToByteArray-a4d947(Lcom/android/server/BackupManagerService;Ljava/lang/String;)[B
    ...
    #calls: Lcom/android/server/BackupManagerService;->hexToByteArray(Ljava/lang/String;)[B
    invoke-static {v0, v8}, Lcom/android/server/BackupManagerService;->access$invoke-hexToByteArray-a4d947(Lcom/android/server/BackupManagerService;Ljava/lang/String;)[B
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/BackupManagerService;->access$invoke-buildPasswordKey-b9aa12(Lcom/android/server/BackupManagerService;Ljava/lang/String;[BI)Ljavax/crypto/SecretKey;
    ...
    #calls: Lcom/android/server/BackupManagerService;->hexToByteArray(Ljava/lang/String;)[B
    invoke-static {v0, v12}, Lcom/android/server/BackupManagerService;->access$invoke-hexToByteArray-a4d947(Lcom/android/server/BackupManagerService;Ljava/lang/String;)[B
    ...
    invoke-static {v0, v13, v7, v1}, Lcom/android/server/BackupManagerService;->access$invoke-makeKeyChecksum-47d90f(Lcom/android/server/BackupManagerService;[B[BI)[B
...
.method installApk(Lcom/android/server/BackupManagerService$FileMetadata;Ljava/lang/String;Ljava/io/InputStream;)Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/BackupManagerService;->access$iget-mPackageManager-abe961(Lcom/android/server/BackupManagerService;)Landroid/content/pm/PackageManager;
    ...
    invoke-static {v0, v12, v11}, Lcom/android/server/BackupManagerService;->access$invoke-signaturesMatch-bfa1ae(Lcom/android/server/BackupManagerService;[Landroid/content/pm/Signature;Landroid/content/pm/PackageInfo;)Z
...
.method readAppManifest(Lcom/android/server/BackupManagerService$FileMetadata;Ljava/io/InputStream;)Lcom/android/server/BackupManagerService$RestorePolicy;
    ...
    #calls: Lcom/android/server/BackupManagerService;->signaturesMatch([Landroid/content/pm/Signature;Landroid/content/pm/PackageInfo;)Z
    invoke-static {v0, v15, v12}, Lcom/android/server/BackupManagerService;->access$invoke-signaturesMatch-bfa1ae(Lcom/android/server/BackupManagerService;[Landroid/content/pm/Signature;Landroid/content/pm/PackageInfo;)Z
...
.method tearDownAgent(Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-static {v1}, Lcom/android/server/BackupManagerService;->access$iget-mActivityManager-c670e0(Lcom/android/server/BackupManagerService;)Landroid/app/IActivityManager;
