...
.field private mPhoneIsRegistered:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;)V
    ...
    invoke-virtual {v5, v11, v7}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v8, v3}, Lcom/android/internal/telephony/PhoneFactory;->getServiceName(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v7, p0, Lcom/android/server/location/GpsLocationProvider;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    .line 468
    iget-object v7, p0, Lcom/android/server/location/GpsLocationProvider;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    invoke-direct {p0, v3}, Lcom/android/server/location/GpsLocationProvider;->mPhoneStateListener(I)Landroid/telephony/PhoneStateListener;

    move-result-object v8

    invoke-virtual {v7, v8, v11}, Landroid/telephony/TelephonyManager;->listen(Landroid/telephony/PhoneStateListener;I)V
...
.method static synthetic access$602(Lcom/android/server/location/GpsLocationProvider;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 84
    iput p1, p0, Lcom/android/server/location/GpsLocationProvider;->mPhoneIsRegistered:I
...
.method private mPhoneStateListener(I)Landroid/telephony/PhoneStateListener;
    .locals 1
    .parameter "phoneId"
...
.method private startNavigating(Z)V
    ...
    const-string v4, "get the agps enable option is "
    ...
    const-string v4, "after set mPositionMode = "
    ...
    .line 1005
    .restart local v6       #enableOption:I
    :cond_4
    if-nez v6, :cond_1

    .line 1006
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    iget v0, p0, Lcom/android/server/location/GpsLocationProvider;->mPhoneIsRegistered:I
