...
.method static synthetic access$invoke-writeAppManifest-ed427c(Lcom/android/server/BackupManagerService$PerformFullBackupTask;Landroid/content/pm/PackageInfo;Ljava/io/File;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$invoke-writeApkToBackup-de1906(Lcom/android/server/BackupManagerService$PerformFullBackupTask;Landroid/content/pm/PackageInfo;Landroid/app/backup/BackupDataOutput;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private backupSharedStorage()V
    ...
    invoke-static {v4}, Lcom/android/server/BackupManagerService;->access$iget-mPackageManager-abe961(Lcom/android/server/BackupManagerService;)Landroid/content/pm/PackageManager;
...
.method private emitAesBackupHeader(Ljava/lang/StringBuilder;Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    invoke-static/range {v17 .. v18}, Lcom/android/server/BackupManagerService;->access$invoke-randomBytes-01da27(Lcom/android/server/BackupManagerService;I)[B
    ...
    invoke-static {v0, v1, v15, v2}, Lcom/android/server/BackupManagerService;->access$invoke-buildPasswordKey-b9aa12(Lcom/android/server/BackupManagerService;Ljava/lang/String;[BI)Ljavax/crypto/SecretKey;
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/server/BackupManagerService;->access$iget-mRng-396d40(Lcom/android/server/BackupManagerService;)Ljava/security/SecureRandom;
    ...
    invoke-static {v0, v15}, Lcom/android/server/BackupManagerService;->access$invoke-byteArrayToHex-f5f235(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
    ...
    #calls: Lcom/android/server/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v7}, Lcom/android/server/BackupManagerService;->access$invoke-byteArrayToHex-f5f235(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
    ...
    #calls: Lcom/android/server/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v3}, Lcom/android/server/BackupManagerService;->access$invoke-byteArrayToHex-f5f235(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v7, v2}, Lcom/android/server/BackupManagerService;->access$invoke-makeKeyChecksum-47d90f(Lcom/android/server/BackupManagerService;[B[BI)[B
    ...
    #calls: Lcom/android/server/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v8}, Lcom/android/server/BackupManagerService;->access$invoke-byteArrayToHex-f5f235(Lcom/android/server/BackupManagerService;[B)Ljava/lang/String;
...
.method private tearDown(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-static {v2}, Lcom/android/server/BackupManagerService;->access$iget-mActivityManager-c670e0(Lcom/android/server/BackupManagerService;)Landroid/app/IActivityManager;
...
.method private writeAppManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Z)V
    ...
    #getter for: Lcom/android/server/BackupManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    invoke-static {v8}, Lcom/android/server/BackupManagerService;->access$iget-mPackageManager-abe961(Lcom/android/server/BackupManagerService;)Landroid/content/pm/PackageManager;
...
.method public run()V
    ...
    #getter for: Lcom/android/server/BackupManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    invoke-static/range {v21 .. v21}, Lcom/android/server/BackupManagerService;->access$iget-mPackageManager-abe961(Lcom/android/server/BackupManagerService;)Landroid/content/pm/PackageManager;
