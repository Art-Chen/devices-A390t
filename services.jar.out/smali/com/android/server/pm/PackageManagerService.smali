...
.field final mPreInstallDir:Ljava/io/File;

.field final mPreInstallObserver:Landroid/os/FileObserver;
...
.field scanFile:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/PackageManagerService;->UNIVERSE_UI_SUPPORT:Z
...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->scanFile:Ljava/util/List;
    ...
    iput-boolean v2, v0, Lcom/android/server/pm/PackageManagerService;->engModeEnable:Z
    ...
    iget-boolean v4, v0, Lcom/android/server/pm/PackageManagerService;->engModeEnable:Z
    ...
    .line 916
    .local v29, separateProcesses:Ljava/lang/String;
    if-eqz v29, :cond_6
    ...
    const-string v3, "/system/preloadapp"

    invoke-direct {v2, v3}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mPreInstallDir:Ljava/io/File;
    ...
    .end local v25           #paths:[Ljava/lang/String;
    .end local v28           #scanMode:I
    .end local v29           #separateProcesses:Ljava/lang/String;
    ...
    .line 922
    .restart local v29       #separateProcesses:Ljava/lang/String;
    :cond_5
    const/4 v2, 0x0
    ...
    .restart local v25       #paths:[Ljava/lang/String;
    .restart local v28       #scanMode:I
    ...
    iput-boolean v2, v0, Lcom/android/server/pm/PackageManagerService;->mFlagInstall:Z
    ...
    iget-boolean v2, v0, Lcom/android/server/pm/PackageManagerService;->engModeEnable:Z
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mPreInstallObserver:Landroid/os/FileObserver;
    ...
    const-string v3, " begin scan the apps !"
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lcom/android/server/pm/PackageManagerService;->scanDirLIOnly(IIJ)V

    .line 1099
    const-string v2, "PackageManager"

    const-string v3, " end scan the apps !"
    ...
    .line 1125
    .local v27, psit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/server/pm/PackageSetting;>;"
    :cond_14
    :goto_b
    ...
    .end local v27           #psit:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/server/pm/PackageSetting;>;"
    :cond_15
    new-instance v2, Ljava/io/File;
    ...
    iget-object v3, v0, Lcom/android/server/pm/PackageManagerService;->mPreInstallDir:Ljava/io/File;
    ...
    iget-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mPreInstallObserver:Landroid/os/FileObserver;
...
.method private copySO(Ljava/io/File;Ljava/lang/String;Ljava/io/File;)V
    .locals 4
    ...
    invoke-interface {v2, v3}, Llibcore/io/Os;->lstat(Ljava/lang/String;)Llibcore/io/StructStat;

    move-result-object v2

    iget v2, v2, Llibcore/io/StructStat;->st_mode:I

    invoke-static {v2}, Llibcore/io/OsConstants;->S_ISLNK(I)Z
    :try_end_0
    ...
    invoke-virtual {v2, p2}, Lcom/android/server/pm/Installer;->unlinkNativeLibraryDirectory(Ljava/lang/String;)I

    .line 4159
    :cond_0
    invoke-static {p3, p1}, Lcom/android/internal/content/NativeLibraryHelper;->copyNativeBinariesIfNeededLI(Ljava/io/File;Ljava/io/File;)I

    .line 4160
    return-void

    .line 4146
    .end local v1           #isSymLink:Z
    :catch_0
    move-exception v0
...
.method private delAppRecord(Ljava/lang/String;I)Z
    .locals 7
    .parameter "packageName"
    .parameter "parseFlags"
    ...
    const-string v4, "/data/app/.delrecord"

    invoke-direct {v0, v4}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 3016
    .local v0, delRecord:Ljava/io/File;
    const/4 v2, 0x0
    ...
    const-string v5, "preloadapp unInstall record:  IOException"
...
.method private deletePackageLI(Ljava/lang/String;ZILcom/android/server/pm/PackageManagerService$PackageRemovedInfo;Z)Z
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/pm/PackageManagerService;->killApplication(Ljava/lang/String;I)V

    .line 7413
    iget-object v2, v1, Landroid/content/pm/PackageParser$Package;->mPath:Ljava/lang/String;

    iget-object v3, v1, Landroid/content/pm/PackageParser$Package;->mPath:Ljava/lang/String;
    ...
    invoke-direct {p0, v7}, Lcom/android/server/pm/PackageManagerService;->isPreloadApp(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, p3}, Lcom/android/server/pm/PackageManagerService;->delAppRecord(Ljava/lang/String;I)Z
...
.method private isDeleteApp(Ljava/lang/String;)Z
    .locals 8
    .parameter "packageName"
    ...
    const-string v5, "/data/app/.delrecord"

    invoke-direct {v4, v5}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 2992
    .local v4, unInstallRecord:Ljava/io/File;
    const/4 v0, 0x0
    ...
    .line 2996
    .local v3, lineContent:Ljava/lang/String;
    :cond_0
    :try_start_1
    ...
    .end local v3           #lineContent:Ljava/lang/String;
    ...
    .restart local v3       #lineContent:Ljava/lang/String;
    :cond_2
    if-eqz v1, :cond_3
    ...
    const-string v6, " isDeleteApp IOException"
    ...
    const-string v6, " isDeleteApp Close ... IOException"
    ...
    const-string v7, " isDeleteApp Close ... IOException"
...
.method private isPreloadApp(Ljava/lang/String;)Z
    ...
    .prologue
    .line 2985
    const-string v0, "/system/preloadapp"
...
.method private scanDirLIOnly(IIJ)V
    .locals 9
    .parameter "flags"
    .parameter "scanMode"
    .parameter "currentTime"
    ...
    .prologue
    .line 2840
    iget-object v0, p0, Lcom/android/server/pm/PackageManagerService;->scanFile:Ljava/util/List;

    const-string v2, "/system/app/AudioProfile.apk"
    ...
    const-string v2, "/system/app/BackupRestoreConfirmation.apk"
    ...
    const-string v2, "/system/app/Bluetooth.apk"
    ...
    const-string v2, "/system/app/Camera.apk"
    ...
    const-string v2, "/system/app/DefaultContainerService.apk"
    ...
    const-string v2, "/system/app/DrmProvider.apk"
    ...
    const-string v2, "/system/app/FMPlayer.apk"
    ...
    const-string v2, "/system/app/KeyChain.apk"
    ...
    const-string v2, "/system/app/LatinIME.apk"
    ...
    const-string v2, "/system/app/MediaProvider.apk"
    ...
    const-string v2, "/system/app/NoiseField.apk"
    ...
    const-string v2, "/system/app/PhaseBeam.apk"
    ...
    const-string v2, "/system/app/PicoTts.apk"
    ...
    const-string v2, "/system/app/Provision.apk"
    ...
    const-string v2, "/system/app/SettingsProvider.apk"
    ...
    const-string v2, "/system/app/SharedStorageBackup.apk"
    ...
    const-string v2, "/system/app/SystemUI.apk"
    ...
    const-string v2, "/system/app/TelephonyProvider.apk"
    ...
    const-string v2, "/system/app/UserDictionaryProvider.apk"
    ...
    const-string v2, "/system/app/ValidationTools.apk"
    ...
    const-string v2, "/system/app/ValidationtoolsFm.apk"
    ...
    const-string v2, "/system/app/VpnDialogs.apk"
    ...
    const-string v2, "/system/app/WAPPushManager.apk"
    ...
    const-string v2, "/system/app/engineeringmodel.apk"
    ...
    const-string v2, "/system/app/lockscreen.apk"
    ...
    const-string v2, "/system/app/modemassert.apk"
    ...
    const-string v2, "/system/app/SystemUpdate.apk"
    ...
    const-string v2, "/system/app/CellBroadcastReceiver.apk"
    ...
    const-string v2, "/system/app/CertInstaller.apk"
    ...
    const-string v2, "/system/app/mxdcmmbplayer.apk"
    ...
    const-string v2, "/system/app/Mms.apk"
    ...
    const-string v2, "/system/app/MsmsPhone.apk"
    ...
    const-string v2, "/system/app/MsmsSettings.apk"
    ...
    const-string v2, "/system/app/MsmsStk.apk"
    ...
    const-string v2, "/system/app/PackageInstaller.apk"
    ...
    const-string v2, "/system/app/Launcher2.apk"
    ...
    const-string v2, "/system/app/ApplicationsProvider.apk"
    ...
    const-string v2, "/system/app/Contacts.apk"
    ...
    const-string v2, "/system/app/ContactsProvider.apk"
    ...
    iput-object v0, p0, Lcom/android/server/pm/PackageManagerService;->scanFile:Ljava/util/List;
...
.method private scanPackageLI(Landroid/content/pm/PackageParser$Package;IIJ)Landroid/content/pm/PackageParser$Package;
    ...
    .line 3332
    .local v50, scanFile:Ljava/io/File;
    if-eqz v50, :cond_0
    ...
    .line 3399
    .local v44, pkgSetting:Lcom/android/server/pm/PackageSetting;
    invoke-static/range {p1 .. p1}, Lcom/android/server/pm/PackageManagerService;->isSystemApp(Landroid/content/pm/PackageParser$Package;)Z
    ...
    .line 3470
    .local v47, renamed:Ljava/lang/String;
    move-object/from16 v0, p1
    ...
    .line 3513
    .end local v47           #renamed:Ljava/lang/String;
    :cond_13
    move-object/from16 v0, p0
    ...
    .line 3484
    .restart local v47       #renamed:Ljava/lang/String;
    :cond_15
    move-object/from16 v0, p1
    ...
    .line 3619
    .local v35, orig:Lcom/android/server/pm/PackageSetting;
    if-eqz v35, :cond_23
    ...
    .line 3628
    .end local v24           #i:I
    .end local v35           #orig:Lcom/android/server/pm/PackageSetting;
    ...
    invoke-virtual/range {v50 .. v50}, Ljava/io/File;->lastModified()J

    move-result-wide v51

    .line 3633
    .local v51, scanFileTime:J
    ...
    .line 3759
    :goto_d
    invoke-virtual/range {v50 .. v50}, Ljava/io/File;->getPath()Ljava/lang/String;
    ...
    .line 3835
    sget-boolean v3, Lcom/android/server/pm/PackageManagerService;->UNIVERSE_UI_SUPPORT:Z
    ...
    iget-boolean v3, v0, Lcom/android/server/pm/PackageManagerService;->mFlagInstall:Z
    :try_end_9
    ...
    :try_end_a
    .catch Llibcore/io/ErrnoException; {:try_start_a .. :try_end_a} :catch_2
    ...
    .line 3798
    .local v33, ne:Ljava/lang/NullPointerException;
    const/16 v26, 0x1

    goto :goto_13

    .line 3804
    .end local v33           #ne:Ljava/lang/NullPointerException;
    :catch_2
    move-exception v20
    ...
    .line 3889
    .local v45, r:Ljava/lang/StringBuilder;
    const/16 v24, 0x0
    ...
    .end local v30           #names:[Ljava/lang/String;
    .end local v39           #p:Landroid/content/pm/PackageParser$Provider;
    .end local v45           #r:Ljava/lang/StringBuilder;
    :cond_3f
    ...
    .restart local v30       #names:[Ljava/lang/String;
    .restart local v38       #p:Landroid/content/pm/PackageParser$Provider;
    .restart local v45       #r:Ljava/lang/StringBuilder;
    :cond_42
    move-object/from16 v0, v38
    ...
    check-cast v49, Landroid/content/pm/PackageParser$Service;

    .line 3951
    .local v49, s:Landroid/content/pm/PackageParser$Service;
    ...
    .line 3963
    .end local v49           #s:Landroid/content/pm/PackageParser$Service;
    :cond_4d
    if-eqz v45, :cond_4e
    ...
    .line 4060
    .local v53, tree:Lcom/android/server/pm/BasePermission;
    if-eqz v53, :cond_60
    ...
    .line 4093
    .end local v53           #tree:Lcom/android/server/pm/BasePermission;
    :cond_61
    :goto_29
    move-object/from16 v0, v16
    ...
    .restart local v53       #tree:Lcom/android/server/pm/BasePermission;
    :cond_64
    const/16 v3, 0x20
...
.method private scanPackageLI(Ljava/io/File;IIJ)Landroid/content/pm/PackageParser$Package;
    ...
    const-string v3, "/data/app/.delrecord"

    invoke-direct {v15, v3}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 3052
    .local v15, delRecord:Ljava/io/File;
    ...
    invoke-direct {v0, v3}, Lcom/android/server/pm/PackageManagerService;->isPreloadApp(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v3}, Lcom/android/server/pm/PackageManagerService;->isDeleteApp(Ljava/lang/String;)Z
