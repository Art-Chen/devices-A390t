...
.field private mChargerCurrent:I
...
.method private processValues()V
    ...
    .line 266
    :goto_2
    sget-boolean v0, Landroid/os/Build;->IS_AT720:Z
...
.method private final sendIntent()V
    ...
    .line 426
    const-string v2, "chargercurrent"

    iget v3, p0, Lcom/android/server/BatteryService;->mChargerCurrent:I
    ...
    .line 428
    const-string v2, "statuslast"

    iget v3, p0, Lcom/android/server/BatteryService;->mLastBatteryStatus:I
...
.method private final shutdownIfNoPower()V
    ...
    const-string v1, "android.intent.action.ACTION_REQUEST_SHUTDOWN_FULLSCREEN"
