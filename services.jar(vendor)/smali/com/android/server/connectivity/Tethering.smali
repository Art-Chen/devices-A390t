...
.method private showTetheredNotification(I)V
    ...
    const-string v7, "com.android.settings.SprdUsbSettings"
...
.method public enableUsbGser(Z)Z
    .locals 4
    .parameter "enabled"
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->isUsbGserStarted()Z
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->startUsbGser()V
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->stopUsbGser()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Fail to enableUsbGser:"
...
.method public enableUsbUdcpower(Z)Z
    .locals 4
    .parameter "enabled"
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->isUsbUdcpowerStarted()Z
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->startUsbUdcpower()V
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->stopUsbUdcpower()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Error toggling usb Udcpower:"
...
.method public enableUsbVser(Z)Z
    .locals 4
    .parameter "enabled"
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->isUsbVserStarted()Z
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->startUsbVser()V
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->stopUsbVser()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Error toggling usb Vser :"
...
.method public isUsbConnected()Z
    ...
    .prologue
    .line 602
    invoke-virtual {p0}, Lcom/android/server/connectivity/Tethering;->isUsbUdcpowerStarted()Z

    move-result v1

    .line 603
    .local v1, udcEnabled:Z
    const-string v2, "Tethering"
    ...
    .line 606
    :try_start_0
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering;->mNMService:Landroid/os/INetworkManagementService;

    invoke-interface {v2}, Landroid/os/INetworkManagementService;->isUsbConnected()Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Error toggling usb Status :"
    ...
    :cond_0
    iget-boolean v2, p0, Lcom/android/server/connectivity/Tethering;->mUsbConnected:Z
...
.method public isUsbGserStarted()Z
    ...
    const-string v3, "Error toggling usb Gser :"
...
.method public isUsbRNDISStarted()Z
    ...
    invoke-interface {v1}, Landroid/os/INetworkManagementService;->isUsbRNDISStarted()Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Error toggling usb RNDIS :"
...
.method public isUsbUdcpowerStarted()Z
    ...
    const-string v3, "Fail to exec isUsbUdcpowerStarted:"
